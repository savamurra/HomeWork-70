...
export const createContact = createAsyncThunk<void, IContactsForm>(
  "contact/createDish",
  async (contact: IContactsForm) => {
...
export const getContacts = createAsyncThunk<IContact[], void>(
  "contact/getContact",
  async () => {
    const response: { data: ContactList | null } =
      await axiosApi.get("contact.json");
