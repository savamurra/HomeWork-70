...
export const deleteLoading = (state: RootState) =>
  state.contact.isDeleteLoading;
...
export const { openModal, transition, closeModal, resetSelectedContact } =
